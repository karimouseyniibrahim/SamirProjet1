...
@push('header')
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="{{ url('admin/trajet/pluck') }}" ><i class="fa fa-trash"></i></button>
...
@push('search')
    <form method="get" class="form-inline">
        ...
        <a href="{{ url('admin/trajet') }}" class="btn btn-danger" ><i class="fa fa-close"></i></a>
    </form>
@endpush

@section('content')
    @include(layoutTable() , ['title' => trans('trajet.trajet') , 'model' => 'trajet' , 'table' => $dataTable->table([] , true) ])
@endsection
