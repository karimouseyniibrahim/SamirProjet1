...
@push('header')
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="{{ url('admin/medias/pluck') }}" ><i class="fa fa-trash"></i></button>
...
@push('search')
    <form method="get" class="form-inline">
        ...
        <a href="{{ url('admin/medias') }}" class="btn btn-danger" ><i class="fa fa-close"></i></a>
    </form>
@endpush

@section('content')
    @include(layoutTable() , ['title' => trans('medias.medias') , 'model' => 'medias' , 'table' => $dataTable->table([] , true) ])
@endsection
